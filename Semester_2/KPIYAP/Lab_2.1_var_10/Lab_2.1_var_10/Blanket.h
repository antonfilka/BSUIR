...
int option_menu(int* option)
{
    ...
    while(!scanf("%d", &*option) || (*option < 1) || (*option > 5))
    {
...
void show_all (struct Animals* animal, int* amount, int* option)
{
    if(*amount == 0)
    {
...
int menu (struct Animals* animal, int* amount, int* option)
{
    int choice;
    ...
    {
        case 1:
            add(animal, amount, option);
            break;
        case 2:
            show_all(animal, amount, option);
            break;
        case 3:
